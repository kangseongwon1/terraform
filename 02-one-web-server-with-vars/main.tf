...
module "vpc" {
  ...
  private_subnets = slice(var.private_subnet_cidr_blocks, 0, var.private_subnets_count)
  public_subnets  = slice(var.public_subnet_cidr_blocks, 0, var.public_subnets_count)

  enable_nat_gateway = true
  enable_vpn_gateway = var.disable_vpn_gateway
